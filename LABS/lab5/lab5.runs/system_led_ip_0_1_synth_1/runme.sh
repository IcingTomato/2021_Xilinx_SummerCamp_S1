...
HD_PWD='/home/peter/Documents/PYNQ/LABS/lab5/lab5/lab5.runs/system_led_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_led_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_led_ip_0_1.tcl
