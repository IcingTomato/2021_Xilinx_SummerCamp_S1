...
HD_PWD='C:/Summer_School_Lab/FIR/FIR.runs/system_fir_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_fir_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_fir_top_0_0.tcl
